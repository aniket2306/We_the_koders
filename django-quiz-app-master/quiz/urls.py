...
urlpatterns = [ url(r'^$', view=index, name='index'),
                ...
                url(r'^notification/show/(?P<notification_id>\d+)/$',view=show_notification,name='show_notification'),
                url(r'^notification/delete/(?P<notification_id>\d+)/$',view=delete_notification,name='delete_notification'),
                #url(r'^leaderboard/',view=leaderboard_views.as_view(),name='leaderboard'),
